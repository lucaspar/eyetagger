...
class Profile(models.Model):
    ...
    is_test = models.BooleanField(default=False)  # type: ignore
...
class Image(models.Model):
    ...
    nir_illumination = models.CharField(
        max_length=1,
        blank=True,
        choices=nir_illumination,
    )
...
class UserSerializer(serializers.ModelSerializer):
    annotations = serializers.PrimaryKeyRelatedField(
        many=True,
